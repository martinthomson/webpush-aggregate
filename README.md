...
list and review the [working group home page](|https://tools.ietf.org/wg/webpush|). If you're
...
list](https://www.ietf.org/mailman/listinfo/webpush). This will ensure that
